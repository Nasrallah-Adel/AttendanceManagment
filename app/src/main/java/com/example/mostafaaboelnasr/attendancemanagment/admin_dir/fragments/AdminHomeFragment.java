...
//                                transaction.commit();
                                ...
                                args.putString("key", "Students");
                                newFragment.setArguments(args);
                                fragmentTransaction.add(R.id.viewpager_adminContainer, newFragment);
                                fragmentTransaction.addToBackStack("search");
                                fragmentTransaction.commit();

                                studentsLayout.setEnabled(true);
                                studentsProgressBar.setVisibility(View.GONE);
                            }
                        }, 600);
...
//                                transaction.commit();
                                ...
                                tutorsLayout.setEnabled(true);
                                tutorsProgressBar.setVisibility(View.GONE);
                            }
                        }, 600);
...
//                                transaction.commit();
                                ...
                                hallsLayout.setEnabled(true);
                                hallsProgressBar.setVisibility(View.GONE);
                            }
                        }, 600);
...
//                                transaction.commit();
                                ...
                                subjectsLayout.setEnabled(true);
